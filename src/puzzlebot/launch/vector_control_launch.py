...
more_intelligent_lidar_config = os.path.join(package_share, 'config', 'more_intelligent_lidar_constants.yaml')
...
def generate_launch_description() -> LaunchDescription:
    ...
    vector_control = Node(
        package=package_name,
        executable='vector_control',
        name='vector_control',
        output='screen',
        parameters=[more_intelligent_lidar_config]
    )
